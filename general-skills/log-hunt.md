# [Log Hunt (General Skills, Easy)](https://play.picoctf.org/practice/challenge/527)
...
- Solution:
```bash
schufot-picoctf@webshell:~$ cat server.log | grep pico
...
schufot-picoctf@webshell:~$ cat server.log | grep _
[1990-08-09 10:00:10] INFO FLAGPART: picoCTF{us3_
